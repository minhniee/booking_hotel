    ...
    <div class="navbar">
        ...
        <div class="navContainer">
            ...
            <c:if test="${not empty sessionScope.account }">
                <div class="navIteams">
                    <button class="navButton" onclick="window.location.href='${url}/login.jsp'">Hello, ${account.userName}</button>
                </div>
            </c:if>
        </div>
    </div>
...
<div class="header">
    <div class="headerContainer">
        <div class="headerList">
            ...
            <div class="headerListItem">
                <img src="${url}/fontawesome-free-6.5.2-web/svgs/solid/car.svg" style="color: white" width="30" height="20" />
        ...
        <div class="headerSreach">
            ...
            <c:if test="${ empty sessionScope.account }">
                <div class="headerSearchIteam">
                    <button class="headerBtn" onclick="window.location.href='https://google.com'">Sign on/ Register</button>
                </div>
            </c:if>
        </div>
    </div>
