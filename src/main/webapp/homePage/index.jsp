...
<!-- Mirrored from duruthemes.com/demo/html/cappa/demo1-light/index13.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Jun 2024 06:12:54 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-6 p-0 order1 animate-box" data-animate-effect="fadeInRight">
                <div class="img">
                    <a href="spa-wellness.jsp"><img src="${url}/Assets1/img/spa/3.jpg" alt=""></a>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-6 p-0 animate-box" data-animate-effect="fadeInLeft">
                <div class="img left">
                    <a href="spa-wellness.jsp"><img src="${url}/Assets1/img/spa/2.jpg" alt=""></a>
                </div>
            </div>
            <div class="col-md-6 p-0 bg-cream valign animate-box" data-animate-effect="fadeInRight">
                <div class="content">
        ...
        <div class="row">
            ...
            <div class="col-md-6 p-0 order1 animate-box" data-animate-effect="fadeInRight">
                <div class="img">
                    <a href="spa-wellness.jsp"><img src="${url}/Assets1/img/spa/1.jpg" alt=""></a>
                </div>
            </div>
        </div>
    </div>
...
<section class="testimonials">
    <div class="background bg-img bg-fixed section-padding pb-0" data-background="${url}/Assets1/img/slider/2.jpg" data-overlay-dark="2">
        <div class="container">
            <div class="row">
                <!-- Reservation -->
