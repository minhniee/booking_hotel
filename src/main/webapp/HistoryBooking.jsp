...
<div class="tabular--wrapper">
    ...
    <form action="HistoryBooking1" method="post">
    ...
    <div class="table-container">
        ...
        <table>
            ...
            <c:forEach items="${requestScope.managerBookings}" var="managerBookings">
                <tr>
                    ...
                    <td>
                        <a href="detailListBooking1?id=${managerBookings.id}"><button class="fas fa-info-circle"></button></a>
        ...
        <a href="dashboardstaff.jsp" style="display: flex; justify-content: end"><button class="fas fa-arrow-left" style="border-radius: 5px; background: #00c6ff">Back</button></a>
